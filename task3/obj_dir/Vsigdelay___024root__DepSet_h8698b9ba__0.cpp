...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__sigdelay__DOT__count = vlSelfRef.sigdelay__DOT__count;
    vlSelfRef.__Vdly__sigdelay__DOT__count = ((IData)(vlSelfRef.rst)
                                               ? 0U
                                               : (0xffU 
                                                  & ((IData)(vlSelfRef.sigdelay__DOT__count) 
                                                     + (IData)(vlSelfRef.en))));
}
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*7:0*/ __VdlyVal__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __VdlyVal__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    CData/*7:0*/ __VdlyDim0__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __VdlyDim0__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __VdlySet__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __VdlySet__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    // Body
    __VdlySet__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0U;
    if (vlSelfRef.wr) {
        __VdlyVal__sigdelay__DOT__myRam__DOT__ram_array__v0 
            = vlSelfRef.mic_signal;
        __VdlyDim0__sigdelay__DOT__myRam__DOT__ram_array__v0 
            = (0xffU & ((IData)(vlSelfRef.offset) + (IData)(vlSelfRef.sigdelay__DOT__count)));
        __VdlySet__sigdelay__DOT__myRam__DOT__ram_array__v0 = 1U;
    }
    if (vlSelfRef.rd) {
        vlSelfRef.delayed_signal = vlSelfRef.sigdelay__DOT__myRam__DOT__ram_array
            [vlSelfRef.sigdelay__DOT__count];
    }
    if (__VdlySet__sigdelay__DOT__myRam__DOT__ram_array__v0) {
        vlSelfRef.sigdelay__DOT__myRam__DOT__ram_array[__VdlyDim0__sigdelay__DOT__myRam__DOT__ram_array__v0] 
            = __VdlyVal__sigdelay__DOT__myRam__DOT__ram_array__v0;
    }
}
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.sigdelay__DOT__count = vlSelfRef.__Vdly__sigdelay__DOT__count;
}
